    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Tambah Pulau Baru</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-plus-circle"></i> Form Tambah Pulau</h3>
                    </div>
                    <div class="card-body">
                        @if(session('error'))
                        ...
                        <form action="{{ route('pulau.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_pulau') is-invalid @enderror"
                                       name="nama_pulau" value="{{ old('nama_pulau') }}" required placeholder="Masukkan nama pulau" autocomplete="off">
                                @error('nama_pulau')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                          name="deskripsi" required placeholder="Masukkan deskripsi">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
